...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <a href="{{ url('/user/export_excel') }}" class="btn btn-primary">Export Pengguna</a>
            <a href="{{ url('/user/export_pdf') }}" class="btn btn-warning"><i class="fa fa-file-
                pdf"></i> Export Pengguna</a>
